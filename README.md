...
[![Build Status](https://travis-ci.org/kiang9/go-binance.svg?branch=master)](https://travis-ci.org/kiang9/go-binance)
[![GoDoc](https://godoc.org/github.com/kiang9/go-binance?status.svg)](https://godoc.org/github.com/kiang9/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/kiang9/go-binance)](https://goreportcard.com/report/github.com/kiang9/go-binance)
[![codecov](https://codecov.io/gh/kiang9/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/kiang9/go-binance)
...
```shell
go get github.com/kiang9/go-binance/v2
```
...
```golang
import (
    "github.com/kiang9/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/kiang9/go-binance) for full references.
